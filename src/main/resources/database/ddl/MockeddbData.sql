...
/
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Bill'),1234567890,(Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Todd'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Harry'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Jane'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Brian'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Artem'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Abhijit'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Chrissy'),1234567890,(Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Jim'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'John'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Sally'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'JJ'),1234567890,(Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Sarah'),1234567890,(Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Sara'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'TJ'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Jack'),1234567890, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Phil'),1234567890,(Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Miles'),1234567809,(Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Rick'),1234567809,(Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Carl'),1234560789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Lilly'),1234500789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Mobile')  From dual;

INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Bill'),1234506789,(Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Todd'),1234506789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Harry'),1234056789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Jane'),1234560789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Brian'),1230456789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Artem'),1234056789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Abhijit'),1203456789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Chrissy'),1203456789,(Select PhoneTypeID from PhoneType Where PhoneType = 'Home')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Jim'),1234567089, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'John'),1234560789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Sally'),1234056789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'JJ'),1234567089,(Select PhoneTypeID from PhoneType Where PhoneType = 'Home')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Sarah'),1234056789,(Select PhoneTypeID from PhoneType Where PhoneType = 'Home')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Sara'),1234506789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'TJ'),1234567089, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Jack'),1234056789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Phil'),1234506789,(Select PhoneTypeID from PhoneType Where PhoneType = 'Home')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Miles'),1234056789,(Select PhoneTypeID from PhoneType Where PhoneType = 'Home')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Rick'),1234506789,(Select PhoneTypeID from PhoneType Where PhoneType = 'Home')   From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Carl'),1234506789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
INSERT INTO PHONE  (    PERSONID,        PHONENUMBER,    PHNETYPE  )  Select  (select PersonID From Person where FirstName = 'Lilly'),1230456789, (Select PhoneTypeID from PhoneType Where PhoneType = 'Home')  From dual;
/
...
/
Insert into Game(TEAM1ID,TEAM2ID,Team1Score, Team2score ,REFEREEID,FIELDID,GAMETIME) Select (Select TeamID from Team where TEAMTITLE = 'TEAM1'),(Select TeamID from Team where TEAMTITLE = 'TEAM2'),0,0,10002,10000,trunc(sysdate) from dual;
Insert into Game(TEAM1ID,TEAM2ID,Team1Score, Team2score ,REFEREEID,FIELDID,GAMETIME) Select (Select TeamID from Team where TEAMTITLE = 'TEAM2'),(Select TeamID from Team where TEAMTITLE = 'TEAM3'),0,0,10002,10000,trunc(sysdate+1) from dual;
Insert into Game(TEAM1ID,TEAM2ID,Team1Score, Team2score ,REFEREEID,FIELDID,GAMETIME) Select (Select TeamID from Team where TEAMTITLE = 'TEAM3'),(Select TeamID from Team where TEAMTITLE = 'TEAM1'),0,0,10002,10000,trunc(sysdate+2) from dual;
