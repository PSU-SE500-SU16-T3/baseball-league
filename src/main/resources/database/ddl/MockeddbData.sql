...
/
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Bill','Password' ,'Email@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Manager'),(select PersonID From Person where FirstName = 'Bill') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Todd','Password' ,'Tmail@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Manager'),(select PersonID From Person where FirstName = 'Todd')from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Harry','Password' ,'Hmail@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Manager'),(select PersonID From Person where FirstName = 'Harry') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Jane','Password' ,'Jmail@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Jane') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Brian','Password' ,'Pmail@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Brian') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Artem','Password' ,'Amail@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Artem') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Abhijit','Password' ,'Imail@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Abhijit') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Chrissy','Password' ,'Cmail@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Chrissy') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Jim','Password' ,'a@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Jim') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'John','Password' ,'b@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'John') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Sally','Password' ,'c@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Sally') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'JJ','Password' ,'d@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'JJ') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Sarah','Password' ,'e@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Sarah') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Sara','Password' ,'f@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Sara') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'TJ','Password' ,'g@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'TJ') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Jack','Password' ,'h@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Jack') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Phil','Password' ,'i@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Phil') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Miles','Password' ,'j@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Miles') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Rick','Password' ,'k@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Rick') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Carl','Password' ,'l@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Carl') from dual;
Insert Into Users (Username, Passw, EMAIL, USERROLE, personID) Select 'Lilly','Password' ,'m@Gmail.com',(select RoleID From USERROLE where USERROLE = 'Player'),(select PersonID From Person where FirstName = 'Lilly') from dual;
/
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '2535 Fox Hill Rd','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Bill') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '2535 Fox Hill Rd','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Bill') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '2535 Fox Hill Rd','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Todd') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '2535 Fox Hill Rd','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Todd') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '2535 Fox Hill Rd','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Harry') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '2535 Fox Hill Rd','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Harry') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '679 Waupelani Dr','APT 1','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Jane') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '679 Waupelani Dr','APT 1','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Jane') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '679 Waupelani Dr','APT 2','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Brian') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '679 Waupelani Dr','APT 2','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Brian') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID ) Select '679 Waupelani Dr','APT 3','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Artem') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '679 Waupelani Dr','APT 4','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Artem') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '24 Waupelani Dr','APT 1','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Abhijit') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '24 Waupelani Dr','APT 1','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Abhijit') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '24 Waupelani Dr','APT 2','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Chrissy') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '24 Waupelani Dr','APT 2','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Chrissy') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID ) Select '24 Waupelani Dr','APT 3','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Jim') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID ) Select '24 Waupelani Dr','APT 3','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Jim') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '24 Waupelani Dr','APT 4','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'John') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '24 Waupelani Dr','APT 4','State College', 'PA','16801',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'John') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '348 Blue Course Dr','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Sally') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '348 Blue Course Dr','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Sally') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID ) Select '348 Blue Course Dr','APT 2','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'JJ') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '348 Blue Course Dr','APT 2','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'JJ') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '348 Blue Course Dr','APT 3','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Sarah') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '348 Blue Course Dr','APT 3','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Sarah') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '348 Blue Course Dr','APT 4','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Sara') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '348 Blue Course Dr','APT 5','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Sara') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'TJ') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 1','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'TJ') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 2','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Jack') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 2','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Jack') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 3','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Phil') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 3','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Phil') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 4','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Miles') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 4','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Miles') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 5','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Rick') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 5','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Rick') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 6','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Carl') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 6','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Carl') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 7','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Residential'),(select PersonID From Person where FirstName = 'Lilly') From dual;
INSERT INTO ADDRESS (    LINE1,    LINE2,    CITY,    STATE,    ZIP,    ADDRESSTYPE, personID  ) Select '1013 S Allen St','APT 7','State College', 'PA','16803',(select AddressTypeID From AddressType where AddressType = 'Mailing'),(select PersonID From Person where FirstName = 'Lilly') From dual;
/
...
/
INSERT INTO LEAGUE  (    LEAGUENAME,    LEAGUELOCATION  )  Select  'State College League',    'Nittany Lion Softball Park' From dual;
